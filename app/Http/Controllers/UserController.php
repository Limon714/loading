...
class UserController extends Controller
{
    public function UserLogin(Request $request):JsonResponse{
        try{
            ...
            return ResponseHelper::Out('success','A 6 digit pin has been send to your email address',200);
        }catch(Exception $e){
    ...
    public function VerifyLogin(Request $request):JsonResponse{
            ...
            if($verification){
                ...
                return ResponseHelper::Out('success','You are successfully verified',200)->cookie('token',$token,60*24*30);
            }else{
